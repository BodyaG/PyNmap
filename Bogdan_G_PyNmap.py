#!/usr/bin/env python
# -*- coding: utf-8 -*-
__author__ = "Bogdan Grabovskiy"
__email__ = "bogdangrabovskiy@students.columbiabasin.edu"
__date_ = "Spring 2020"
__version__ = "0.0.1"
...
os.chdir('C:\\Users\\Bodya')
cwd = os.getcwd()
print(cwd)

# SET VARIABLES
my_dir = 'C:\\Users\\Bodya\\Downloads\\tmp'
date_str = date.today().strftime("%m%d%y")
my_pickle = 'C:\\Users\\Bodya\\Downloads\\tmp\\%s.pickle' % date_str
my_json = 'C:\\Users\\Bodya\\Downloads\\tmp\\%s.json' % date_str
